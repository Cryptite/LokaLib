...
public class BlockUtil {
    ...
    public static void dropItemTypeFromBlock(Player p, Block b, Location l, Material type) {
        ...
        ServerLevel world = ((CraftWorld) b.getWorld()).getHandle();
        net.minecraft.world.item.ItemStack nmsItem = CraftItemStack.asNMSCopy(holding);
        BlockPos blockPos = new BlockPos(l.getX(), l.getY(), l.getZ());
        nmsItem.mineBlock(world, world.getBlockState(blockPos), blockPos, ((CraftPlayer) p).getHandle());
    }
}
